...
const OpenRequisition = () => {
    const { openRequisition, loading } = useSelector(({ applications }) => applications)
    console.log(openRequisition)
    ...
    useEffect(() => {
        ...
        // }
    }, [openRequisition, loading])
    return (
        <>
            {loading ? <div className='requisition-list__item'>
